 ...
 * Spaceships will be destroyed if it collides with an asteroid and its parameters
...
{
public:
    // Constructor and destructor. Parameter 'id' shoud be set to either '1' or
    // '2' and acts as an identification parameter.
    SpaceShip(
    ...
    // Method for acquiring and handling a powerUp.
    ...
    void invertStearing(); // TODO: Fix spelling

private:
    // Private method for handling acquired power ups.
    void handlePowerUps();
    ...
    float   ySpeed              = 0.0f;
    bool    isAlive             = true;
    bool    invertedStearing    = false; // TODO: Fix spelling
    bool    beenHit             = false;
