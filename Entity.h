...
public:
    ...
    // object handles themself in their respective 'handleCollision' method,
    ...
    // wants to be destroyed after iterating and false otherwise.
...
protected:
    ...
    // Reference to frame in which the instance of the entity is held.
    GameFrame &gameFrame;
};
